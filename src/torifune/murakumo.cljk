...
(defn collection
  [name]
  (str "com.etzhayyim.torifune." name))

(def cell-specs {
  :ascent-sim {:legacy-cell "cell-torifune-ascent-sim"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "ascent-sim")]
     :required-gates common-gates
     :trigger "manifest cell ascent-sim"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :carbon-balance {:legacy-cell "cell-torifune-carbon-balance"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "carbon-balance")]
     :required-gates common-gates
     :trigger "manifest cell carbon-balance"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :disposal-plan {:legacy-cell "cell-torifune-disposal-plan"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "disposal-plan")]
     :required-gates common-gates
     :trigger "manifest cell disposal-plan"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :datom-emit {:legacy-cell "cell-torifune-datom-emit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "datom-emit")]
     :required-gates common-gates
     :trigger "manifest cell datom-emit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
